...
Begin VB.Form ExamEForm 
   ...
   Begin VB.ComboBox Combo3 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "ExamEForm.frx":415E5
      Left            =   1800
      List            =   "ExamEForm.frx":415F5
      TabIndex        =   3
      Text            =   "I"
      Top             =   1320
      Width           =   1095
   ...
   Begin VB.ComboBox Combo2 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "ExamEForm.frx":41609
      Left            =   1800
      List            =   "ExamEForm.frx":4160B
      TabIndex        =   2
      Top             =   840
      Width           =   1815
   End
...
Case 1
    ...
    Conn.Execute "delete from  examMarks where dname='" & Combo1 & "' and subname='" & Combo2 & "' and sem='" & Combo3 & "' and regNo='" & Text1 & "'"
