VERSION 5.00
Begin VB.Form TestEForm 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Student Internal Marks Entry"
   ClientHeight    =   6015
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10305
   ...
   Begin VB.ComboBox Combo4 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "TestEForm.frx":415E5
      Left            =   1920
      List            =   "TestEForm.frx":415F5
      TabIndex        =   22
      Text            =   "I"
      Top             =   1680
      Width           =   1095
   ...
   Begin VB.ComboBox Combo3 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "TestEForm.frx":41609
      Left            =   1920
      List            =   "TestEForm.frx":41619
      TabIndex        =   3
      Text            =   "I"
      Top             =   1200
      Width           =   1095
   ...
   Begin VB.ComboBox Combo2 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "TestEForm.frx":4162D
      Left            =   1920
      List            =   "TestEForm.frx":4162F
      TabIndex        =   2
      Top             =   720
      Width           =   1815
   End
...
Case 1
    ...
    Conn.Execute "delete from  testMarks where dname='" & Combo1 & "' and subname='" & Combo2 & "' and sem='" & Combo3 & "' and testno='" & Combo4 & "' and regNo='" & Text1 & "'"
...
Case 2
    ...
    Conn.Execute "update TestMarks set dName = '" & Combo1 & "',subName = '" & Combo2 & "',sem = '" & Combo3 & "',tMarks=" & Val(Text3) & " where rNo=" & RNo & ""
